...
#define CUSTOM_MACHINE_NAME "IDEX RC7 v4"
...
#define MESH_BED_LEVELING    // Enable mesh bed leveling.
  ...
  #define MESH_HOME_SEARCH_Z 10  // Z after Home, bed somewhere below but above 0.0.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,180,400,417.5}  // default steps per unit for Ultimaker
